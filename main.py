...
def main():
    ...
    def create_training_data():
        ...
        for img in os.listdir(datadir):
            ...
            # Pass exception in case we are unable to read an image due to corruption, ignore that image
                ...
                pass
        return training_validation_data, training_data, validation_data
    ...
    training_validation_data, training_data, validation_data = create_training_data()
    ...
    validationsplit = 0.85
    numtosplit = int(validationsplit * (len(training_validation_data)))
    ...
    for i in range(num_epochs):
        ...
        # Reshape arrays and convert to numpy arrays
